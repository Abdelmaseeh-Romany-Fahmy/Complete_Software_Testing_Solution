...
public class CheckoutWithRegisterData {
	 FileInputStream stream = null;
	 public FileInputStream connectExcelFile() {
	        String filePath = System.getProperty("user.dir") + "\\src\\main\\java\\Excel\\CheckoutData.xlsx";
	  ...
	  public Object[][] getExcelLoginData() throws IOException {
	        ...
	        XSSFSheet contactSheet = workBook.getSheet("Sheet2");

	        int nRows = contactSheet.getLastRowNum() + 1; 
